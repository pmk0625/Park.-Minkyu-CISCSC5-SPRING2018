 ...
 * Created on April 5, 2018, 09:55 AM
...
int main(int argc, char** argv) {
    ...
    short mxThrw;  //Max Throws
    float avgThrw; //Average Throws
    ...
    //Output data
    out<<"Number of Craps Games Played = "<<setw(10)<<games<<endl;
    ...
    out<<"Average Throws per game = "<<avgThrw<<endl;
